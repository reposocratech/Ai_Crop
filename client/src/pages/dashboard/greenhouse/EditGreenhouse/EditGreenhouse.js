...
export const EditGreenhouse = () => {
  ...
  let disable = false;
  if (
    !editGreenhouse?.greenhouse_name ||
    !editGreenhouse?.greenhouse_location ||
    !editGreenhouse?.greenhouse_orientation ||
    !editGreenhouse?.greenhouse_size ||
    !editGreenhouse?.greenhouse_type ||
    editGreenhouse?.responsibility_acknowledged === 0
  ) {
    disable = true;
  }
  ...
  const handleSubmit = () => {
    ...
    axios
      .put(`http://localhost:4000/greenhouse/editGreenhouse/${greenhouse_id}`, {
        editGreenhouse,
        arrayMeasures,
      })
      .then((res) => {
          ...
          <main className="main2_creategh">
            ...
            <section className="sect_1">
              ...
              <div className="checkbox_cont">
                <div>
                  <p>
                    Si las medidas no son las correctas, asumo la
                    responsabilidad
                  </p>
                  <input
                    type="checkbox"
                    name="responsibility_acknowledged"
                    value={editGreenhouse.responsibility_acknowledged}
                    defaultChecked
