...
export const Info = () => {
  return (
    <Row className="cont_auth d-flex flex-column p-0">
      <TopNavBar />
      <section className=" contPpalInfo d-flex justify-content-center">
        <h2 className="fuenteFront title">
          Elije tu plan de precios <span className="spanPunto punto">.</span>
        </h2>
        {/* card one */}
