...
class CropController {
    ...
    createCrop = (req, res) => {
        let {crop_name, crop_duration, crop_size, crop_plant_variety, greenhouse_id} = req.body;
        
        let sql = `INSERT INTO crop (crop_name,  crop_duration, crop_size, crop_plant_variety, greenhouse_id) VALUES ("${crop_name}", "${ crop_duration}", "${crop_size}", "${crop_plant_variety}", ${greenhouse_id})`;
