...
class GreenhouseController {
    ...
    getAllGreenhouses = (req, res) => {
        ...
        connection.query(sqlOwner, (error, resultOwner) => {
            ...
            let sqlCollaborator = `SELECT greenhouse.*, CONCAT(user.first_name, " ", user.last_name) as collaborator_full_name, count(alarm.alarm_id) as active_alarms FROM greenhouse LEFT JOIN user_greenhouse ON user_greenhouse.greenhouse_id = greenhouse.greenhouse_id LEFT JOIN user ON user_greenhouse.user_id = user.user_id LEFT JOIN alarm ON alarm.greenhouse_id = greenhouse.greenhouse_id WHERE user.user_id = ${user_id} ${ownerFilter} GROUP BY greenhouse_id`;
