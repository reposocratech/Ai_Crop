...
async function main(email, name, user_first_name, user_last_name, greenhouse_id) {
  ...
  let info = await transporter.sendMail({
    ...
    text: `Hola ${name}! ${user_first_name} ${user_last_name} te ha invitado a unirte a su invernadero en AI crop. ¡Ahora puedes echarle un vistazo y ver todos sus detalles!`, // plain text body
